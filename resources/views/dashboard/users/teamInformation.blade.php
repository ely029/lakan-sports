...
@endif
        ...
        <div class="row vertical-gap">
            <div class="col-md-12">
                <div class="nk-widget">
                    <h4 class="nk-widget-title"><span class="text-main-1">Register</span>Now</h4>
                    <div class="nk-widget-content">
                        <form action="{{ route('dashboard.updateuser')}}" method="POST" id="registration-form" enctype="multipart/form-data">
                        <input type="hidden" name="pic_url" id="pic_url"/>
                        @csrf
                        <div class="row" style="margin-bottom:20px;">
                                <div class="col-md-6">
                                <img id="team-logo" src="{{ Auth::user()->photo_url }}" height="100" width="100">
                                <img id="team-pic" src="{{asset('assets/images/avatar.png')}}" height="100" width="100">
                                </div>
                            </div>
                            <div class="row vertical-gap sm-gap">
                                <div class="col-md-6">
                                    <input type="email" value="{{ Auth::user()->email }}" class="form-control required" name="email" placeholder="Email *">
                                    <br/>
                                    <input type="file" class="form-control required" name="photo" value="Upload Team Logo"accept="image/x-png,image/gif,image/jpeg" />
                                    <br/>
                                    <input type="file" class="form-control required" name="photo" value="Upload Team Pic"accept="image/x-png,image/gif,image/jpeg" />
                                    <br/>
                                </div>
                                <div class="col-md-6">
                                    <input type="text" class="form-control required" name="team_name" value="{{ Auth::user()->team_name}}" placeholder="Team Name *">
                                    <br/>
                                    <input type="text" class="form-control required" name="team_coach" placeholder="Team Coach *" value="{{ Auth::user()->team_coach }}"/>
                                    <br/>
                                </div>
                            </div>
                            <div class="nk-gap"></div>
                            <textarea class="form-control required" name="team_description" rows="5" placeholder="Team Description *">{{ Auth::user()->team_description }}</textarea>
