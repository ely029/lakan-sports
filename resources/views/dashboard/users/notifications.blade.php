...
<div class="container">
<h4 class="nk-widget-title"><span class="text-main-1">Noti</span>fications</h4>
...
<div class="row">
    <div class="col-md-12">
    <span>{{ $detail->team_1}} Is requesting you to join battle with them at {{ $detail->date}}, {{ $detail->time}}</span>
    <div>
    <a href="{{ route('dashboard.acceptInvitation', $detail->id) }}" class="btn btn-success"> Accept Invitation</a>
    <a href="" class="btn btn-danger"> Decline Invitation</a>
    </div>
    </div>
</div>
@endforeach
