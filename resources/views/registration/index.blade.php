            ...
            <div class="col-md-12">
                <div class="nk-widget">
                    ...
                    <div class="nk-widget-content">
                        <form action="{{ route('register.create')}}" method="POST" id="registration-form" enctype="multipart/form-data">
                        <input type="hidden" name="pic_url" id="pic_url"/>
                        @csrf
                        <div class="row" style="margin-bottom:20px;">
                                <div class="col-md-6">
                                <img id="team-logo" src="{{asset('assets/images/avatar.png')}}" height="100" width="100">
                                </div>
                            </div>
                            <div class="row vertical-gap sm-gap">
                                <div class="col-md-6">
                                    ...
                                    <br/>
                                    <input type="file" class="form-control required" name="photo" accept="image/x-png,image/gif,image/jpeg" />
                                    <br/>
                                    <input type="password" placeholder="Password *" value="{{ old('password') }}" name="password" class="form-control required"/>
                                    <br/>
                                </div>
                                <div class="col-md-6">
                                    <input type="text" class="form-control required" name="team_name" value="{{ old('team_name') }}" placeholder="Team Name *">
                                    <br/>
                                    <input type="text" class="form-control required" name="team_coach" placeholder="Team Coach *" value="{{ old('team_coach') }}"/>
                                    <br/>
                                </div>
                            </div>
                            <div class="nk-gap"></div>
                            <textarea class="form-control required" name="team_description" rows="5" placeholder="Team Description *">{{ old('team_description') }}</textarea>
