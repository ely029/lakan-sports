...
<div class="container">
    ...
    <!-- START: Latest News -->
    <div class="nk-gap-2"></div>
    <h3 class="nk-decorated-h-2"><span><span class="text-main-1">Tour</span>nament</span></h3>
    <div class="nk-gap"></div>
    @foreach ($details as $detail)
    <div class="nk-match">
                <div class="nk-match-team-left">
                    <a href="#" data-toggle="modal" data-target="#teamLeft">
                        <span class="nk-match-team-logo">
                            <img src="{{ $detail->team_1_photo}}" alt="" width="100" height="100">
                        </span>
                ...
                <div class="modal fade" id="teamLeft" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <button type="button" class="btn btn-primary">Save changes</button>
                ...
                <div class="nk-match-status">
                    <a href="#">
                        ...
                        @if ($detail->is_in_progress === 1)
                        <span class="nk-match-score bg-dark-1">Now Playing</span>
                        @else
                        <span class="nk-match-score bg-dark-1">Upcoming</span>
                        @endif
                    </a>
                </div>
                <div class="nk-match-team-right">
                    <a href="#">
                        ...
                        <span class="nk-match-team-logo">
                            <img src="{{ $detail->team_2_photo}}" alt="" width="100" height="100">
                        </span>
                    </a>
                </div>
            </div>
